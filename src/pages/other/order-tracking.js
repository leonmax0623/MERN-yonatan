...
const OrderTracking = () => {
  return (
    <LayoutHome>
      ...
      <Row style={{ marginBottom: "120px", paddingLeft: "30px", paddingRight: "30px", alignItems: "center" }}>
      ...
      <Row style={{ marginBottom: "120px", paddingLeft: "30px", paddingRight: "30px", alignItems: "center" }}>
        <Col xl={8} lg={8} style={{ display: "flex", paddingLeft: "60px", textAlign: "right" }}>
          <div className="about-widget ">
            <h2 className="widget-title space-mb--25" style={{ fontFamily: "cargenregular", fontSize: "35px", lineHeight: "inherit" }}>Unforgettable moments</h2>
            <p className="widget-content" style={{ fontFamily: "sailecmedium", fontSize: "15px" }}>
      ...
      <Row className="no-gutters" style={{ marginBottom: "100px", marginTop: "100px" }}>
        <Col lg={12}>
