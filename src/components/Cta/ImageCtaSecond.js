        ...
        <Row>
          <Col xl={6} lg={6} className="mr-auto" style={{ display: "flex", alignItems: "center" }}>
            <div className="about-widget ">
              <h2 className="widget-title space-mb--25" style={{ fontFamily: "cargenregular", fontSize: "45px" }}>Nice to meet you</h2>
              <h2 className="widget-title space-mb--25" style={{ fontFamily: "cargenregular", fontSize: "45px" }}>My name is Jonathan</h2>
